...
1. **[2308.11361](http://arxiv.org/abs/2308.11361)** Skyrmion motion in magnetic anisotropy gradients: Acceleration caused by deformation (magnetic gradient, arXiv)
...
1. **[2308.11303](http://arxiv.org/abs/2308.11303)** Theory of defect-induced crystal field perturbations in rare earth magnets (arXiv)

1. **[2308.12055](http://arxiv.org/abs/2308.12055)** Symmetry indicator-free unconventionality, obstructed edge states and Majorana engineering in 1T-PtSe2 family (**Bernevig**, arXiv)

1. **[PhysRevB.108.075426](https://link.aps.org/doi/10.1103/PhysRevB.108.075426)** Origin of strain tunability in flat valence band and ultrahigh shear piezoelectricity in superflexible non--van der Waals graphitic $\\mathrm{Sc}X$ monolayers ($X=\\mathrm{P}$, As, Sb) (PRB)

1. **[PhysRevB.108.075153](https://link.aps.org/doi/10.1103/PhysRevB.108.075153)** Experimental demonstration of the band compression effect in engineered kagome-honeycomb lattices (PRB)

1. **[PhysRevB.108.L060506](https://link.aps.org/doi/10.1103/PhysRevB.108.L060506)** Topological superconductivity enhanced by exceptional points (PRB)




1. **[PhysRevLett.131.086601](https://link.aps.org/doi/10.1103/PhysRevLett.131.086601)** Chiral-Flux-Phase-Based Topological Superconductivity in Kagome Systems with Mixed Edge Chiralities (kagome, PRL)

1. **[PhysRevLett.131.081401](https://link.aps.org/doi/10.1103/PhysRevLett.131.081401)** Probing the Pulsar Explanation of the Galactic-Center GeV Excess Using Continuous Gravitational-Wave Searches (PRL)


1. **[2308.12750](http://arxiv.org/abs/2308.12750)** Theoretical designing of multiband Nickelate and Palladate superconductors with $d^{8+\\delta}$ configuration (arXiv)

1. **[2308.12703](http://arxiv.org/abs/2308.12703)** Second-order topological superconductor via noncollinear magnetic texture (**noncollinear magnetic texture SC**, arXiv)

1. **[2308.12942](http://arxiv.org/abs/2308.12942)** Excitons in twisted AA' hexagonal boron nitride bilayers (arXiv)

1. **[2308.12569](http://arxiv.org/abs/2308.12569)** Dynamics of quantum spin-nematics: comparisons with canted antiferromagnets (**nematic spin**, arXiv)

1. **[2308.12358](http://arxiv.org/abs/2308.12358)** variPEPS -- a versatile tensor network library for variational ground state simulations in two spatial dimensions (arXiv)

1. **[2308.12410](http://arxiv.org/abs/2308.12410)** Magnetic analogue of liquid-gas phase transition of water: case study of a spin-1/2 Ising-Heisenberg model on a diamond-decorated square lattice (**spin**, arXiv)

1. **[2308.12931](http://arxiv.org/abs/2308.12931)** Fragility of spectral flow for topological phases in non-Wigner-Dyson classes (Luka, arXiv)

1. **[2308.12922](http://arxiv.org/abs/2308.12922)** Electron trapping in graphene quantum dots with magnetic flux (graphene QD, arXiv)

1. **[2308.12335](http://arxiv.org/abs/2308.12335)** Spin pumping from a ferromagnetic insulator into an altermagnet (altermagnet, arXiv)

1. **[2308.12500](http://arxiv.org/abs/2308.12500)** Strain Dependent Spin Hall Magnetoresistance in the Multiferroic Antiferromagnet BiFeO$_3$ (strain, arXiv)

1. **[PhysRevLett.131.083801](https://link.aps.org/doi/10.1103/PhysRevLett.131.083801)** Observation of a Topological Edge State Stabilized by Dissipation (PRL)

1. **[PhysRevLett.131.081601](https://link.aps.org/doi/10.1103/PhysRevLett.131.081601)** Variational Neural-Network Ansatz for Continuum Quantum Field Theory (PRL)
