...
1. **[PhysRevLett.129.263604](https://link.aps.org/doi/10.1103/PhysRevLett.129.263604)** Observation of Non-Abelian Charged Nodes Linking Nonadjacent Gaps (PRL)

1. **[PhysRevLett.129.267401](https://link.aps.org/doi/10.1103/PhysRevLett.129.267401)** **Disorder-Induced Topological State Transition in the Optical Skyrmion Family (skyrmion, PRL)**

1. **[PhysRevLett.129.266401](https://link.aps.org/doi/10.1103/PhysRevLett.129.266401)** Nonstoichiometric Salt Intercalation as a Means to Stabilize Alkali Doping of 2D Materials (PRL)

1. **[PhysRevB.106.214207](https://link.aps.org/doi/10.1103/PhysRevB.106.214207)** Localization transitions and winding numbers for non-Hermitian Aubry-Andr\\'e-Harper models with off-diagonal modulations (PRB)

1. **[PhysRevB.106.214524](https://link.aps.org/doi/10.1103/PhysRevB.106.214524)** **Theory of giant diode effect in $d$-wave superconductor junctions on the surface of a topological insulator (nagaosa, PRB)**

1. **[PhysRevB.106.224425](https://link.aps.org/doi/10.1103/PhysRevB.106.224425)** Magnetic correlations in the magnetic topological insulator ${(\\mathrm{Cr},\\mathrm{Sb})}_{2}{\\mathrm{Te}}_{3}$ (PRB)

1. **[PhysRevB.106.245425](https://link.aps.org/doi/10.1103/PhysRevB.106.245425)** Quantum anomalous layer Hall effect in the topological magnet ${\\mathrm{MnBi}}_{2}{\\mathrm{Te}}_{4}$ (PRB)

1. **[PhysRevB.106.L220409](https://link.aps.org/doi/10.1103/PhysRevB.106.L220409)** Anisotropic linear and nonlinear charge-spin conversion in topological semimetal ${\\mathrm{SrIrO}}_{3}$ (PRB)

1. **[PhysRevB.106.224423](https://link.aps.org/doi/10.1103/PhysRevB.106.224423)** (${\\mathrm{Fe}}_{1\\ensuremath{-}x}{\\mathrm{Ni}}_{x}{)}_{5}{\\mathrm{GeTe}}_{2}$: An antiferromagnetic triangular Ising lattice with itinerant magnetism (PRB)


1. **[2212.11757](http://arxiv.org/abs/2212.11757)** Fractional transconductance via non-adiabatic topological Cooper pair pumping (arXiv)

1. **[2212.11855](http://arxiv.org/abs/2212.11855)** Closed-loop machine learning for discovery of novel superconductors (arXiv)

1. **[2212.11964](http://arxiv.org/abs/2212.11964)** Structure of Charge Density Waves in La1.875Ba0.125CuO4 (arXiv)

1. **[2212.11283](http://arxiv.org/abs/2212.11283)** Marginal Fermi liquid at magnetic quantum criticality from dimensional confinement (arXiv)




1. **[PhysRevLett.129.266601](https://link.aps.org/doi/10.1103/PhysRevLett.129.266601)** **Superconductor-Insulator Transition in a Non-Fermi Liquid (PRL)**

1. **[PhysRevLett.129.267201](https://link.aps.org/doi/10.1103/PhysRevLett.129.267201)** **Emergent Magnetomultipoles and Nonlinear Responses of a Magnetic Hopfion (Nagaosa, PRL)**

1. **[PhysRevB.106.214427](https://link.aps.org/doi/10.1103/PhysRevB.106.214427)** Magnetic field tuning of parallel spin stripe order and fluctuations near the pseudogap quantum critical point in ${\\mathrm{La}}_{1.36}{\\mathrm{Nd}}_{0.4}{\\mathrm{Sr}}_{0.24}{\\mathrm{CuO}}_{4}$ (PRB)

1. **[PhysRevB.106.214429](https://link.aps.org/doi/10.1103/PhysRevB.106.214429)** Variational quantum eigensolver for the Heisenberg antiferromagnet on the kagome lattice (PRB)

1. **[PhysRevB.106.214522](https://link.aps.org/doi/10.1103/PhysRevB.106.214522)** Low-energy spin fluctuations in ${\\mathrm{FeSe}}_{0.95}{\\mathrm{S}}_{0.05}$ (PRB)

1. **[PhysRevB.106.214523](https://link.aps.org/doi/10.1103/PhysRevB.106.214523)** Pairing of fermions under spin-orbit coupling in two dimensions (PRB)

1. **[PhysRevB.106.224309](https://link.aps.org/doi/10.1103/PhysRevB.106.224309)** Floquet band engineering with Bloch oscillations (PRB)

1. **[PhysRevB.106.235148](https://link.aps.org/doi/10.1103/PhysRevB.106.235148)** Metal to Wigner-Mott insulator transition in two-leg ladders (PRB)

1. **[researchers push preprint reviews](https://www.science.org/content/article/researchers-push-preprint-reviews-improve-scientific-communications)** Researchers push preprint reviews to improve scientific communications (Science)
