...
1. **[PhysRevB.107.134435](https://link.aps.org/doi/10.1103/PhysRevB.107.134435)** Creating long-range entangled Majorana pairs: From spin-$\\frac{1}{2}$ twisted Kitaev to generalized $XY$ chains (**HYKee**, PRB)

1. **[PhysRevX.13.021016](https://link.aps.org/doi/10.1103/PhysRevX.13.021016)** Observation of Spin-Wave Moire Edge and Cavity Modes in Twisted Magnetic Lattices (PRX)

1. **[PhysRevLett.130.176101](https://link.aps.org/doi/10.1103/PhysRevLett.130.176101)** Acoustic Amplifying Diode Using Nonreciprocal Willis Coupling  (PRL)

1. **[PhysRevLett.130.176303](https://link.aps.org/doi/10.1103/PhysRevLett.130.176303)** Phonon-Assisted Intertube Electronic Transport in an Armchair Carbon Nanotube Film  (PRL)

1. **[PhysRevLett.130.176501](https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.130.176501)** Signatures of Supersymmetry in the 5/2 Fractional Quantum Hall Effect (PRL)

1. **[acs.nanolett.3c00718](https://doi.org/10.1021/acs.nanolett.3c00718)** Topological Equivalence of Stripy States and Skyrmion Crystals (Nano Letters)
