...
1. **[PhysRevLett.129.147202](https://link.aps.org/doi/10.1103/PhysRevLett.129.147202)** Excitations in the Ordered and Paramagnetic States of Honeycomb Magnet ${\\mathrm{Na}}_{2}{\\mathrm{Co}}_{2}{\\mathrm{TeO}}_{6}$ (PRL)

1. **[PhysRevB.106.125428](https://link.aps.org/doi/10.1103/PhysRevB.106.125428)** Role of the edges in a quasicrystalline Haldane model (PRB)

1. **[PhysRevB.106.L121118](https://link.aps.org/doi/10.1103/PhysRevB.106.L121118)** Unremovable linked nodal structures protected by crystalline symmetries in stacked bilayer graphene with Kekul\\'e texture (BJYang, PRB)

1. **[PhysRevB.106.115440](https://link.aps.org/doi/10.1103/PhysRevB.106.115440)** Floquet renormalization group approach to the periodically driven Kondo model (Kondo, PRB)

1. **[PhysRevB.106.125155](https://link.aps.org/doi/10.1103/PhysRevB.106.125155)** Superconducting pairing from repulsive interactions of fermions in a flat-band system (flatband, PRB)

1. **[PhysRevB.106.125156](https://link.aps.org/doi/10.1103/PhysRevB.106.125156)** Surface state evolution induced by magnetic order in axion insulator candidate ${\\mathrm{EuIn}}_{2}{\\mathrm{As}}_{2}$ (PRB)


1. **[2209.14824](https://arxiv.org/abs/2209.14824)** Spin-wave spectra in antidot lattice with inhomogeneous perpendicular magnetocrystalline anisotropy (spin-wave, arXiv)
...
1. **[2209.13506](http://arxiv.org/abs/2209.13506)** Single crystal growth of iridates without platinum impurities (BJKim, arXiv.org)
