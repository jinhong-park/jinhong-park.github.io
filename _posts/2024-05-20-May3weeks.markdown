...
1. **[adfm.202405296](https://onlinelibrary.wiley.com/doi/abs/10.1002/adfm.202405296)** Designing and Constructing a Skyrmion Diode Device via Antiferromagnetic Exchange Bias Engineering (Advanced Functional Materials)

1. **[5.0197833](https://doi.org/10.1063/5.0197833)** Control of half-skyrmion movement for possible applications in memory, logic, and neuromorphic computing prototype devices (Applied Physics Reviews)

1. **[PhysRevB.109.184518](https://link.aps.org/doi/10.1103/PhysRevB.109.184518)** Majorana modes and their Floquet engineering in a trapped-ion system (PRB)
