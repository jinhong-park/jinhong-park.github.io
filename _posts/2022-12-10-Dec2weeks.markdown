...
1. **[PhysRevLett.129.240601](https://link.aps.org/doi/10.1103/PhysRevLett.129.240601)** Phase-Separation Kinetics in the Two-Dimensional Long-Range Ising Model (Ising, PRL)

1. **[PhysRevLett.129.246404](https://link.aps.org/doi/10.1103/PhysRevLett.129.246404)** Assessing Nontrivial Topology in Weyl Semimetals by Dichroic Photoemission (PRL)

1. **[PhysRevLett.129.247602](https://link.aps.org/doi/10.1103/PhysRevLett.129.247602)** Soft-Phonon and Charge-Density-Wave Formation in Nematic ${\\mathrm{BaNi}}_{2}{\\mathrm{As}}_{2}$ (PRL)

1. **[PhysRevB.106.235112](https://link.aps.org/doi/10.1103/PhysRevB.106.235112)** Local Kekul\\'e distortion turns twisted bilayer graphene into topological Mott insulators and superconductors (kekule, PRB)

1. **[PhysRevB.106.245111](https://link.aps.org/doi/10.1103/PhysRevB.106.245111)** **Superexchange and spin-orbit coupling in monolayer and bilayer chromium trihalides (CrI3, PRB)**

1. **[PhysRevB.106.214411](https://link.aps.org/doi/10.1103/PhysRevB.106.214411)** Easy-plane anisotropic-exchange magnets on a honeycomb lattice: Quantum effects and dealing with them (honeycomb, PRB)

1. **[PhysRevB.106.214412](https://link.aps.org/doi/10.1103/PhysRevB.106.214412)** Low-energy magnon excitations and emerging anisotropic nature of short-range order in ${\\mathrm{CrI}}_{3}$ (CrI3, PRB)

1. **[PhysRevB.106.245113](https://link.aps.org/doi/10.1103/PhysRevB.106.245113)** Transition from band insulator to Mott insulator and formation of local moment in the half-filled ionic $\\mathrm{SU}(N)$ Hubbard model (PRB)

1. **[PhysRevB.106.245410](https://link.aps.org/doi/10.1103/PhysRevB.106.245410)** Anomalous surface conductivity of Weyl semimetals (PRB)

1. **[s169](https://physics.aps.org/articles/v15/s169)** Dark Matter Goes Down to the Wire (Physics)




1. **[2212.04447](http://arxiv.org/abs/2212.04447)** Observation of Flat Band, Dirac Nodal Lines and Topological Surface States in Kagome Superconductor CsTi$_3$Bi$_5$ (kagome, arXiv)

1. **[2212.04299](http://arxiv.org/abs/2212.04299)** Topology of chalcogen chains (arXiv)

1. **[2212.04460](http://arxiv.org/abs/2212.04460)** Tunable van Hove singularity without structural instability in Kagome metal CsTi$_3$Bi$_5$ (kagome, arXiv)



1. **[science.abq1158](https://www.science.org/doi/abs/10.1126/science.abq1158)** Competition-level code generation with AlphaCode (Science)

1. **[science.add8258](https://www.science.org/doi/abs/10.1126/science.add8258)** AlphaCode and “data-driven” programming  (Science)


1. **[s41586-022-05384-8](https://www.nature.com/articles/s41586-022-05384-8)** Chiral assemblies of pinwheel superlattices on substrates (Nature)

1. **[PhysRevX.12.040002](https://link.aps.org/doi/10.1103/PhysRevX.12.040002)** **Editorial: Altermagnetism---A New Punch Line of Fundamental Magnetism (Altermagnetism, PRX)**

1. **[PhysRevX.12.040501](https://link.aps.org/doi/10.1103/PhysRevX.12.040501)** **Emerging Research Landscape of Altermagnetism (Altermagnetism, PRX)**

1. **[PhysRevLett.129.246402](https://link.aps.org/doi/10.1103/PhysRevLett.129.246402)** Hyperbolic Topological Band Insulators (Bzdušek, PRL)

1. **[PhysRevLett.129.247201](https://link.aps.org/doi/10.1103/PhysRevLett.129.247201)** Fragmented Spin Ice and Multi-$k$ Ordering in Rare-Earth Antiperovskites (PRL)

1. **[PhysRevLett.129.247701](https://link.aps.org/doi/10.1103/PhysRevLett.129.247701)** Charge-Noise-Induced Dephasing in Silicon Hole-Spin Qubits (DLoss, PRL)

1. **[PhysRevB.106.214305](https://link.aps.org/doi/10.1103/PhysRevB.106.214305)** Light-induced translation symmetry breaking via nonlinear phononics (PRB)

1. **[PhysRevB.106.214409](https://link.aps.org/doi/10.1103/PhysRevB.106.214409)** Persistent corner spin mode at the quantum critical point of a plaquette Heisenberg model (PRB)

1. **[PhysRevB.106.224504](https://link.aps.org/doi/10.1103/PhysRevB.106.224504)** Interlayer coherence in superconductor bilayers (PRB)

1. **[PhysRevB.106.224505](https://link.aps.org/doi/10.1103/PhysRevB.106.224505)** Quasidisorder-induced topology (PRB)

1. **[PhysRevB.106.224506](https://link.aps.org/doi/10.1103/PhysRevB.106.224506)** Effective quasiclassical models for odd-frequency superconductivity: Energy-inversion symmetry, preserved spectral weight, and Meissner response (PRB)

1. **[PhysRevB.106.235111](https://link.aps.org/doi/10.1103/PhysRevB.106.235111)** Magnetotransport in overdoped ${\\mathrm{La}}_{2\\ensuremath{-}x}{\\mathrm{Sr}}_{x}{\\mathrm{CuO}}_{4}$: Effect of anisotropic scattering (PRB)

1. **[PhysRevB.106.235408](https://link.aps.org/doi/10.1103/PhysRevB.106.235408)** Enhanced orbital magnetic field effects in Ge hole nanowires (PRB)

1. **[PhysRevB.106.245109](https://link.aps.org/doi/10.1103/PhysRevB.106.245109)** Electronic and topological properties of extended two-dimensional Su-Schrieffer-Heeger models and realization of flat edge bands (PRB)

1. **[PhysRevB.106.245409](https://link.aps.org/doi/10.1103/PhysRevB.106.245409)** Analytical solutions of topological surface states in a series of lattice models (PRB)

1. **[PhysRevB.106.L220402](https://link.aps.org/doi/10.1103/PhysRevB.106.L220402)** Atomistic simulations of distortion-limited high-speed dynamics of antiferromagnetic skyrmions (PRB)

1. **[PhysRevB.106.L241101](https://link.aps.org/doi/10.1103/PhysRevB.106.L241101)** Optical signature for distinguishing between Mott-Hubbard, intermediate, and charge-transfer insulators (PRB)

1. **[PhysRevB.106.L241102](https://link.aps.org/doi/10.1103/PhysRevB.106.L241102)** Dominant superconducting correlations in a Luttinger liquid induced by spin fluctuations (PRB)

1. **[191](https://physics.aps.org/articles/v15/191)** Meet the Unimon, the New Qubit on the Block (Physics)



1. **[2212.01653](https://arxiv.org/abs/2212.01653)** Fusion protocol for Majorana modes in coupled quantum dots (JDSau, arXiv) **[2206.08045](https://arxiv.org/abs/2206.08045)** Realization of a minimal Kitaev chain in coupled quantum dots (Kouwenhoven, arXiv)
