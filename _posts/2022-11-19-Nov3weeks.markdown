...
1. **[science.abp8278](https://www.science.org/doi/abs/10.1126/science.abp8278)** Carbon nanotube transistors: Making electronics from molecules (nanotube, Science)

1. **[s41586-022-05127-9](https://www.nature.com/articles/s41586-022-05127-9)** **Switchable chiral transport in charge-ordered kagome metal CsV3Sb5 (kagome, Nature)**

1. **[s41586-022-05262-3](https://www.nature.com/articles/s41586-022-05262-3)** Control of chiral orbital currents in a colossal magnetoresistance material (Nature)





1. **[PhysRevLett.129.216402](https://link.aps.org/doi/10.1103/PhysRevLett.129.216402)** **Charge Density Wave in Kagome Lattice Intermetallic ${\\mathrm{ScV}}_{6}{\\mathrm{Sn}}_{6}$ (kagome, PRL)**

1. **[PhysRevB.106.174422](https://link.aps.org/doi/10.1103/PhysRevB.106.174422)** **Magnetic dynamics of ${\\mathrm{NiPS}}_{3}$ (NiPS3, PRB)**

1. **[PhysRevB.106.184207](https://link.aps.org/doi/10.1103/PhysRevB.106.184207)** Wave-function extreme value statistics in Anderson localization (PRB)

1. **[PhysRevB.106.184509](https://link.aps.org/doi/10.1103/PhysRevB.106.184509)** Violation of Pauli-Clogston limit in the heavy-fermion superconductor ${\\mathrm{CeRh}}_{2}{\\mathrm{As}}_{2}$: Duality of itinerant and localized $4f$ electrons (Ce, PRB)

1. **[PhysRevB.106.184510](https://link.aps.org/doi/10.1103/PhysRevB.106.184510)** **Effect of realistic out-of-plane dopant potentials on the superfluid density of overdoped cuprates (cuprate, PRB)**

1. **[PhysRevB.106.195135](https://link.aps.org/doi/10.1103/PhysRevB.106.195135)** Strain-induced orbital-energy shift in antiferromagnetic ${\\mathrm{RuO}}_{2}$ revealed by resonant elastic x-ray scattering (PRB)

1. **[PhysRevB.106.195136](https://link.aps.org/doi/10.1103/PhysRevB.106.195136)** Active orbital degree of freedom and potential spin-orbit-entangled moments in the Kitaev magnet candidate ${\\mathrm{BaCo}}_{2}{({\\mathrm{AsO}}_{4})}_{2}$ (PRB)

1. **[PhysRevB.106.205131](https://link.aps.org/doi/10.1103/PhysRevB.106.205131)** Ab initio electronic structure of metallized ${\\mathrm{NiS}}_{2}$ in the noncollinear magnetic phase (PRB)

1. **[PhysRevB.106.L201406](https://link.aps.org/doi/10.1103/PhysRevB.106.L201406)** Phononic Stiefel-Whitney topology with corner vibrational modes in two-dimensional Xenes and ligand-functionalized derivatives (PRB)



1. **[2211.09483](http://arxiv.org/abs/2211.09483)** Suppression of non-equilibrium quasiparticle transport in flat band superconductors (flatband, arXiv.org)

1. **[2211.09143](http://arxiv.org/abs/2211.09143)** **Robust d-wave superconductivity from the Su-Schrieffer-Heeger-Hubbard model: possible route to high-temperature superconductivity (d-wave SSH HYao, arXiv.org)**

1. **[2211.09254](http://arxiv.org/abs/2211.09254)** Heat transport in Weyl semimetals in the hydrodynamic regime (arXiv.org)

1. **[2211.09282](http://arxiv.org/abs/2211.09282)** **Boundary Ferromagnetism in Zigzag Edged Graphene (graphene, arXiv.org)**

1. **[2211.09290](http://arxiv.org/abs/2211.09290)** Electronic Properties of Pyrochlore-Type Ca2Ir2O7 (arXiv.org)

1. **[2211.09577](http://arxiv.org/abs/2211.09577)** Vibronic order and emergent magnetism in cubic $d^1$ double perovskites (arXiv.org)

1. **[2211.09584](http://arxiv.org/abs/2211.09584)** Mitigating the Hubbard Sign Problem. A Novel Application of Machine Learning (arXiv.org)

1. **[2211.09742](http://arxiv.org/abs/2211.09742)** Anharmonicity reveals the tunability of the charge density wave orders in monolayer VSe$_2$ (arXiv.org)

1. **[PhysRevB.106.L201404](https://link.aps.org/doi/10.1103/PhysRevB.106.L201404)** **Creating and detecting poor man's Majorana bound states in interacting quantum dots (majorana, PRB)**

1. **[PhysRevB.106.L201305](https://link.aps.org/doi/10.1103/PhysRevB.106.L201305)** Interference and parity blockade in transport through a Majorana box (PRB)

1. **[PhysRevB.106.L201304](https://link.aps.org/doi/10.1103/PhysRevB.106.L201304)** Anisotropic spin-to-charge conversion in bismuth (spin-to-charge, PRB)

1. **[PhysRevB.106.L201109](https://link.aps.org/doi/10.1103/PhysRevB.106.L201109)** Role of spin currents on electron-electron interaction in the quantum spin Hall phase (PRB)

1. **[PhysRevB.106.205304](https://link.aps.org/doi/10.1103/PhysRevB.106.205304)** **Wigner molecules in phosphorene quantum dots (QD, PRB)**

1. **[PhysRevB.106.205128](https://link.aps.org/doi/10.1103/PhysRevB.106.205128)** Higher-order topological state induced by $d$-wave competing orders in high-${T}_{c}$ superconductor based heterostructures (PRB)

1. **[PhysRevB.106.195416](https://link.aps.org/doi/10.1103/PhysRevB.106.195416)** Negative-positive oscillation in interfacial friction of a ${\\mathrm{In}}_{2}{\\mathrm{Se}}_{3}$-graphene heterojunction (In2Se3, PRB)

1. **[PhysRevB.106.195134](https://link.aps.org/doi/10.1103/PhysRevB.106.195134)** Magnon scattering modulated planar Hall effect in a ferromagnet/topological insulator heterostructure (PRB)

1. **[PhysRevB.106.184415](https://link.aps.org/doi/10.1103/PhysRevB.106.184415)** Dynamics of spin-$\\frac{1}{2} {J}_{1}--{J}_{2}$ model on the triangular lattice (PRB)

1. **[PhysRevB.106.174418](https://link.aps.org/doi/10.1103/PhysRevB.106.174418)** Anomalous sign inversion of spin-orbit torque in ferromagnetic/nonmagnetic bilayer systems due to self-induced spin-orbit torque (PRB)

1. **[PhysRevB.106.195304](https://link.aps.org/doi/10.1103/PhysRevB.106.195304)** Topological Anderson insulator via disorder-recovered average symmetry (PRB)
