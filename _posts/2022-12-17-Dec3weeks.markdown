...
1. **[PhysRevX.12.041029](https://link.aps.org/doi/10.1103/PhysRevX.12.041029)** **Unifying Kitaev Magnets, Kagome Dimer Models, and Ruby Rydberg Spin Liquids (Vishwanath, PRX)**

1. **[PhysRevLett.129.254301](https://link.aps.org/doi/10.1103/PhysRevLett.129.254301)** Observation of $\\ensuremath{\\pi}/2$ Modes in an Acoustic Floquet System (PRL)

1. **[PhysRevLett.129.257001](https://link.aps.org/doi/10.1103/PhysRevLett.129.257001)** Transport Theory for Topological Josephson Junctions with a Majorana Qubit (PRL)

1. **[PhysRevB.106.224415](https://link.aps.org/doi/10.1103/PhysRevB.106.224415)** Spin-density-wave order controlled by uniaxial stress in ${\\mathrm{CeAuSb}}_{2}$ (Ce, PRB)

1. **[PhysRevB.106.235135](https://link.aps.org/doi/10.1103/PhysRevB.106.235135)** Superconductivity in the twisted bilayer transition metal dichalcogenide ${\\mathrm{WSe}}_{2}$: A quantum cluster study (PRB)

1. **[PhysRevB.106.235414](https://link.aps.org/doi/10.1103/PhysRevB.106.235414)** Structural defects in a Janus MoSSe monolayer: A density functional theory study (PRB)

1. **[PhysRevB.106.214204](https://link.aps.org/doi/10.1103/PhysRevB.106.214204)** Unconventional delocalization in a family of three-dimensional Lieb lattices (PRB)

1. **[PhysRevB.106.245128](https://link.aps.org/doi/10.1103/PhysRevB.106.245128)** Type-II corner modes in topolectrical circuits (PRB)

1. **[PhysRevB.106.214205](https://link.aps.org/doi/10.1103/PhysRevB.106.214205)** **Mean-field approach for Anderson-type off-diagonal disorder (PRB)**

1. **[PhysRevB.106.214417](https://link.aps.org/doi/10.1103/PhysRevB.106.214417)** Spin-singlet ground state of the coupled ${J}_{\\text{eff}}$ = $\\frac{1}{2}$ alternating chain system ${\\mathrm{Sr}}_{2}\\mathrm{Co}({\\mathrm{SeO}}_{3}{)}_{3}$ (PRB)

1. **[PhysRevB.106.214419](https://link.aps.org/doi/10.1103/PhysRevB.106.214419)** **Local magnetic moments due to loop currents in metals (CVarma, PRB)**

1. **[PhysRevB.106.214515](https://link.aps.org/doi/10.1103/PhysRevB.106.214515)** **Flipping of antiferromagnetic to superconducting states in pressurized quasi-one-dimensional manganese-based compounds (JHu, PRB)**

1. **[PhysRevB.106.224413](https://link.aps.org/doi/10.1103/PhysRevB.106.224413)** Nonreciprocal spin waves in ferrimagnetic domain-wall channels (PRB)

1. **[PhysRevB.106.245127](https://link.aps.org/doi/10.1103/PhysRevB.106.245127)** **Theoretical analysis of resonant inelastic x-ray scattering spectra of ${\\mathrm{Ca}}_{2}{\\mathrm{RuO}}_{4}$ (BJKim, PRB)**

1. **[PhysRevB.106.L241106](https://link.aps.org/doi/10.1103/PhysRevB.106.L241106)** **Coexistence of trihexagonal and star-of-David pattern in the charge density wave of the kagome superconductor $A{\\mathrm{V}}_{3}{\\mathrm{Sb}}_{5}$ (kagome, PRB)**




1. **[science.ade2301](https://www.science.org/doi/abs/10.1126/science.ade2301)** Understanding the call of the monopole (Science)

1. **[science.add1644](https://www.science.org/doi/abs/10.1126/science.add1644)** **Dynamical fractal and anomalous noise in a clean magnetic crystal (monopole, Science)**



1. **[2212.07511](http://arxiv.org/abs/2212.07511)** Competing magnetic fluctuations and orders in a multiorbital model of doped SrCo$_2$As$_2$ (arXiv.org)

1. **[2212.07578](http://arxiv.org/abs/2212.07578)** Electronic transport mechanisms in a thin crystal of the Kitaev candidate $\\alpha$-RuCl$_3$ probed through guarded high impedance measurements (arXiv.org)

1. **[2212.07586](http://arxiv.org/abs/2212.07586)** **Vanishing RKKY interactions in Ce-based cage compounds (Ce, arXiv.org)**

1. **[2212.07596](http://arxiv.org/abs/2212.07596)** **Strain-induced superconductivity in Sr2IrO4 (iridates, arXiv.org)**

1. **[2212.07878](http://arxiv.org/abs/2212.07878)** **Observation of a new light-induced skyrmion phase in the Mott insulator Cu2OSeO3 (skyrmion, arXiv.org)**

1. **[2212.07893](http://arxiv.org/abs/2212.07893)** **Hamiltonian inference from dynamical excitations in spin quantum dots (Lado, arXiv.org)**

1. **[2212.07958](http://arxiv.org/abs/2212.07958)** **Non-trivial band topology and orbital-selective electronic nematicity in a new titanium-based kagome superconductor (JHu kagome, arXiv.org)**

1. **[2212.08017](http://arxiv.org/abs/2212.08017)** **Emergent flat band and topological Kondo semimetal driven by orbital-selective correlations (JCano, arXiv.org)**

1. **[2212.07445](http://arxiv.org/abs/2212.07445)** Superconductivity in monolayer and few-layer graphene: III Impurity-induced subgap states and quasi-particle interference patterns (arXiv.org)

1. **[PhysRevLett.129.253001](https://link.aps.org/doi/10.1103/PhysRevLett.129.253001)** Topological Flat Bands in Self-Complementary Plasmonic Metasurfaces (PRL)

1. **[PhysRevLett.129.256401](https://link.aps.org/doi/10.1103/PhysRevLett.129.256401)** Topologically Localized Insulators (Luka, PRL)

1. **[PhysRevB.106.224205](https://link.aps.org/doi/10.1103/PhysRevB.106.224205)** Many-body localization of ${\\mathbb{Z}}_{3}$ Fock parafermions (PRB)

1. **[PhysRevB.106.235129](https://link.aps.org/doi/10.1103/PhysRevB.106.235129)** Topological superconductivity from doping a triplet quantum spin liquid in a flat-band system (flatband, PRB)

1. **[PhysRevB.106.235132](https://link.aps.org/doi/10.1103/PhysRevB.106.235132)** Disorder effects in the ${\\mathbb{Z}}_{3}$ Fock parafermion chain (PRB)

1. **[PhysRevB.106.L220404](https://link.aps.org/doi/10.1103/PhysRevB.106.L220404)** Bulk generalized Dzyaloshinskii-Moriya interaction in $\\mathcal{PT}$-symmetric antiferromagnets (PRB)

1. **[PhysRevB.106.L220405](https://link.aps.org/doi/10.1103/PhysRevB.106.L220405)** Electrical measurement of the spin Hall effect isotropy in ferromagnets with strong spin-orbit interactions (PRB)

1. **[PhysRevB.106.214415](https://link.aps.org/doi/10.1103/PhysRevB.106.214415)** Strain-driven antiferromagnetic exchange interaction in ${\\mathrm{SrMnO}}_{3}$ probed by phase-shifted spin Hall magnetoresistance (PRB)

1. **[PhysRevB.106.214512](https://link.aps.org/doi/10.1103/PhysRevB.106.214512)** Role of the Berry curvature on BCS-type superconductivity in two-dimensional materials (PRB)

1. **[PhysRevB.106.235130](https://link.aps.org/doi/10.1103/PhysRevB.106.235130)** Fracton critical point at a higher-order topological phase transition (PRB)

1. **[PhysRevB.106.235413](https://link.aps.org/doi/10.1103/PhysRevB.106.235413)** Breathing mode in open-orbit magnetotransport: A magnetic lens with a quantum mechanical focal length (PRB)

1. **[PhysRevB.106.245122](https://link.aps.org/doi/10.1103/PhysRevB.106.245122)** Steady helix states in a resonant XXZ Heisenberg model with Dzyaloshinskii-Moriya interaction (PRB)

1. **[PhysRevB.106.245417](https://link.aps.org/doi/10.1103/PhysRevB.106.245417)** **Designer meron lattice on the surface of a topological insulator (JCano, PRB)**

1. **[PhysRevB.106.245418](https://link.aps.org/doi/10.1103/PhysRevB.106.245418)** Sublattice-sensitive Majorana modes (PRB)




1. **[s41586-022-05352-2](https://www.nature.com/articles/s41586-022-05352-2)** Singlet and triplet Cooper pair splitting in hybrid superconducting nanowires (Kouwenhoven, Nature)

1. **[s41586-022-05382-w](https://www.nature.com/articles/s41586-022-05382-w)** Majorana-like Coulomb spectroscopy in the absence of zero-bias peaks (Nature)
