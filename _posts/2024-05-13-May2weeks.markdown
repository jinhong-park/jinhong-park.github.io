...
1. **[2405.08847](http://arxiv.org/abs/2405.08847)** Double symmetry and phase-controlled continuous transformation between skyrmion and meron topology (arXiv)

1. **[acs.nanolett.4c00948](https://doi.org/10.1021/acs.nanolett.4c00948)** Engineering the Band Topology in a Rhombohedral Trilayer Graphene Moire Superlattice (Nano Letters)


1. **[PhysRevB.109.184431](https://link.aps.org/doi/10.1103/PhysRevB.109.184431)** Engineering magnetic domain wall energies in BiFeO3 via epitaxial strain: A route to assess skyrmionic stabilities in multiferroics from first principles (PRB)
