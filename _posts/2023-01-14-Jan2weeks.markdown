...
1. **[2301.04801](http://arxiv.org/abs/2301.04801)** Anisotropic Enhancement of Lower Critical Field in Ultraclean Crystals of Spin-Triplet Superconductor UTe2 (arXiv.org)

1. **[2301.04734](http://arxiv.org/abs/2301.04734)** Construction of Wannier functions from the spectral moments of correlated electron systems (arXiv.org)

1. **[2301.04893](http://arxiv.org/abs/2301.04893)** Stripe Helical Magnetism and Two Regimes of Anomalous Hall Effect in NdAlGe (NdAlGe, arXiv.org)

1. **[PhysRevLett.130.026001](https://link.aps.org/doi/10.1103/PhysRevLett.130.026001)** **Pair Density Wave Order from Electron Repulsion (SRaghu, PRL)**

1. **[PhysRevLett.130.026701](https://link.aps.org/doi/10.1103/PhysRevLett.130.026701)** Direct Optical Probe of Magnon Topology in Two-Dimensional Quantum Magnets (PRL)

1. **[PhysRevLett.130.026702](https://link.aps.org/doi/10.1103/PhysRevLett.130.026702)** Suppressed Fluctuations as the Origin of the Static Magnetic Order in Strained ${\\mathrm{Sr}}_{2}{\\mathrm{RuO}}_{4}$ (PRL)

1. **[PhysRevB.107.014105](https://link.aps.org/doi/10.1103/PhysRevB.107.014105)** Magnetic corner states in a two-dimensional gyromagnetic photonic crystal (PRB)

1. **[PhysRevB.107.014202](https://link.aps.org/doi/10.1103/PhysRevB.107.014202)** Critical and topological phases of dimerized Kitaev chain in presence of quasiperiodic potential (PRB)

1. **[PhysRevB.107.014410](https://link.aps.org/doi/10.1103/PhysRevB.107.014410)** Unconventional thermoelectric transport in tilted Weyl semimetals (PRB)

1. **[PhysRevB.107.035305](https://link.aps.org/doi/10.1103/PhysRevB.107.035305)** Influence of Dirac cone warping and tilting on the Friedel oscillations in a topological insulator (PRB)

1. **[PhysRevB.107.035411](https://link.aps.org/doi/10.1103/PhysRevB.107.035411)** Electrical tuning of valley polarization in monolayer transition metal dichalcogenides (PRB)

1. **[PhysRevB.107.035412](https://link.aps.org/doi/10.1103/PhysRevB.107.035412)** **Remote control of spin polarization of topological corner states (PRB)**

1. **[PhysRevB.107.045118](https://link.aps.org/doi/10.1103/PhysRevB.107.045118)** **Higher-order topological phases emerging from Su-Schrieffer-Heeger stacking (PRB)**
