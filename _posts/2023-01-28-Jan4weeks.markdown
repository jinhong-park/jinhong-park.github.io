...
1. **[PhysRevLett.130.046704](https://link.aps.org/doi/10.1103/PhysRevLett.130.046704)** Interfacial Tuning of Anisotropic Gilbert Damping (PRL)

1. **[PhysRevB.107.014423](https://link.aps.org/doi/10.1103/PhysRevB.107.014423)** Mechanism of paramagnetic spin Seebeck effect (Seebeck, PRB)

1. **[PhysRevB.107.035435](https://link.aps.org/doi/10.1103/PhysRevB.107.035435)** Planar Josephson junctions in germanium: Effect of cubic spin-orbit interaction (DLoss, PRB)

1. **[PhysRevB.107.045141](https://link.aps.org/doi/10.1103/PhysRevB.107.045141)** Pressure suppression of the excitonic insulator state in ${\\mathrm{Ta}}_{2}{\\mathrm{NiSe}}_{5}$ observed by optical conductivity (EI, PRB)

1. **[PhysRevB.107.045428](https://link.aps.org/doi/10.1103/PhysRevB.107.045428)** Ferrotronics for the creation of band gaps in graphene (PRB)

1. **[PhysRevB.107.L020201](https://link.aps.org/doi/10.1103/PhysRevB.107.L020201)** Metal-insulator transition in a two-dimensional system of chiral unitary class (PRB)

1. **[s13](https://physics.aps.org/articles/v16/s13)** The Unimportance of Accurate Financial Knowledge (Physics)
