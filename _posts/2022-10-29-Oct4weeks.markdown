...
1. **[PhysRevLett.129.185301](https://link.aps.org/doi/10.1103/PhysRevLett.129.185301)** Intrinsic Anomalous Hall Effect in a Bosonic Chiral Superfluid (AHE, PRL)

1. **[PhysRevLett.129.185902](https://link.aps.org/doi/10.1103/PhysRevLett.129.185902)** Electron-Phonon Interaction and Longitudinal-Transverse Phonon Splitting in Doped Semiconductors (PRL)

1. **[PhysRevB.106.144437](https://link.aps.org/doi/10.1103/PhysRevB.106.144437)** **Twisted bilayer U(1) Dirac spin liquids (LBalents, PRB)**

1. **[PhysRevB.106.155156](https://link.aps.org/doi/10.1103/PhysRevB.106.155156)** Predicting band gaps and band-edge positions of oxide perovskites using density functional theory and machine learning (PRB)

1. **[PhysRevB.106.134515](https://link.aps.org/doi/10.1103/PhysRevB.106.134515)** Two-dimensional multigap superconductivity in bulk $2H\\text{\\ensuremath{-}}\\mathrm{TaSeS}$ (TaSeS, PRB)

1. **[PhysRevB.106.144111](https://link.aps.org/doi/10.1103/PhysRevB.106.144111)** Large extrinsic phonon thermal Hall effect from resonant scattering (PRB)

1. **[PhysRevB.106.155155](https://link.aps.org/doi/10.1103/PhysRevB.106.155155)** Non-Fermi liquid behavior and quantum criticality in cubic heavy fermion systems with non-Kramers multipolar local moments (YBKim, PRB)

1. **[PhysRevB.106.165424](https://link.aps.org/doi/10.1103/PhysRevB.106.165424)** Effect of ${C}_{3v}$ symmetry breaking on the noncentrosymmetric quantum spin Hall insulating phase and optical characteristics of monolayer PbBiI (C3v , PRB)


1. **[2210.14953](http://arxiv.org/abs/2210.14953)** Bolometric detection of coherent Josephson coupling in a highly dissipative environment (arXiv.org)

1. **[2210.15600](http://arxiv.org/abs/2210.15600)** **Automatic Extraction of Materials and Properties from Superconductors Scientific Literature (ML, arXiv.org)**

1. **[2210.15660](http://arxiv.org/abs/2210.15660)** Nodal pair-density-waves from quarter-metal in crystalline graphene multilayers (arXiv.org)

1. **[2210.14918](http://arxiv.org/abs/2210.14918)** Multiferroicity and Topology in Twisted Transition Metal Dichalcogenides (twited TMDC, arXiv.org)

1. **[2210.15026](http://arxiv.org/abs/2210.15026)** **Anharmonic multiphonon origin of the valence plasmon in SrTi1-xNbxO3 (phonon, arXiv.org)**

1. **[2210.15084](http://arxiv.org/abs/2210.15084)** Oxygen vacancies at the origin of pinned moments in oxide interfaces: the example of tetragonal CuO/SrTiO$_3$ (arXiv.org)

1. **[2210.15094](http://arxiv.org/abs/2210.15094)** Incommensurate antiferromagnetic order in weakly frustrated two-dimensional van der Waals insulator CrPSe$_3$ (YHLee, arXiv.org)

1. **[2210.15168](http://arxiv.org/abs/2210.15168)** Magnetism and Quantum Melting in Moir\\'e-Material Wigner Crystals (AHMacDonald, arXiv.org)

1. **[2210.15530](http://arxiv.org/abs/2210.15530)** **Topological magnons in one-dimensional ferromagnetic Su-Schrieffer-Heeger model with anisotropic interaction (magnon, arXiv.org)**

1. **[2210.15596](http://arxiv.org/abs/2210.15596)** Classification and construction of interacting fractonic higher-order topological phases (arXiv.org)


1. **[s146](https://physics.aps.org/articles/v15/s146)** **Dirt - Is No Barrier to Flocking (quenched disorder, Physics)**


1. **[PhysRevB.106.134111](https://link.aps.org/doi/10.1103/PhysRevB.106.134111)** Partial breakdown of translation symmetry at a structural quantum critical point associated with a ferroelectric soft mode (phonon QCP, PRB)

1. **[PhysRevB.106.134434](https://link.aps.org/doi/10.1103/PhysRevB.106.134434)** **Reciprocal space study of Heisenberg exchange interactions in ferromagnetic metals (FM metal, PRB)**

1. **[PhysRevB.106.134513](https://link.aps.org/doi/10.1103/PhysRevB.106.134513)** Spin-triplet superconducting pairing in doped ${\\mathrm{MoS}}_{2}$ (PRB)

1. **[PhysRevB.106.144434](https://link.aps.org/doi/10.1103/PhysRevB.106.144434)** Krein-unitary Schrieffer-Wolff transformation and band touchings in bosonic Bogoliubov--de Gennes and other Krein-Hermitian Hamiltonians (PRB)

1. **[PhysRevB.106.144512](https://link.aps.org/doi/10.1103/PhysRevB.106.144512)** Neel proximity effect at antiferromagnet/superconductor interfaces (PRB)

1. **[PhysRevB.106.155151](https://link.aps.org/doi/10.1103/PhysRevB.106.155151)** Metal-insulator transition in ${\\mathrm{CuIr}}_{2}{\\mathrm{S}}_{4}$ observed by Cu $K\\ensuremath{\\alpha}$ resonant x-ray emission spectroscopy (PRB)

1. **[PhysRevB.106.155427](https://link.aps.org/doi/10.1103/PhysRevB.106.155427)** Planckian properties of two-dimensional semiconductor systems (Ahn DasSarma, PRB)

1. **[PhysRevB.106.165423](https://link.aps.org/doi/10.1103/PhysRevB.106.165423)** Floquet states and optical conductivity of an irradiated two-dimensional topological insulator (Floquet, PRB)

1. **[PhysRevB.106.L161113](https://link.aps.org/doi/10.1103/PhysRevB.106.L161113)** Observation of superconductivity and its enhancement at the charge density wave critical point in ${\\mathrm{LaAgSb}}_{2}$ (PRB)

1. **[PhysRevB.106.L161114](https://link.aps.org/doi/10.1103/PhysRevB.106.L161114)** **Development of long-range phase coherence on the Kondo lattice (YFYang, PRB)**





1. **[2210.14236](http://arxiv.org/abs/2210.14236)** Bipolaronic superconductivity out of a Coulomb gas (arXiv)

1. **[2210.14591](http://arxiv.org/abs/2210.14591)** Patterning of superconducting two-dimensional electron gases based on AlO$_x$/KTaO$_3$(111) interfaces (KTO SC, arXiv)

1. **[2210.14251](http://arxiv.org/abs/2210.14251)** Ingredients for Generalized Models of $\\kappa$-Phase Organic Charge-Transfer Salts: A Review (organic, arXiv)

1. **[2210.14323](http://arxiv.org/abs/2210.14323)** Field-induced spin level crossings within a quasi-XY antiferromagnetic state in Ba$_{2}$FeSi$_{2}$O$_{7}$ (arXiv)

1. **[2210.14439](http://arxiv.org/abs/2210.14439)** Chemical tuning of a honeycomb magnet through a critical point (arXiv)

1. **[2210.14538](http://arxiv.org/abs/2210.14538)** Evolution of the optical response of the magnetic topological insulators Mn(Bi$_{1-x}$Sb$_{x}$)$_2$Te$_4$ with Sb content (Sb doping AFM-TI, arXiv)

1. **[2210.14683](http://arxiv.org/abs/2210.14683)** Unconventional magneto-resistance, and electronic transition in Mn$_3$Ge Weyl semimetal (Mn3Ge, arXiv)

1. **[2210.14864](http://arxiv.org/abs/2210.14864)** Dimensional reduction and incommensurate dynamic correlations in the $S=\\frac{1}{2}$ triangular-lattice antiferromagnet Ca$_3$ReO$_5$Cl$_2$ (frustration, arXiv)
