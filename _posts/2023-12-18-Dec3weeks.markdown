...
1. **[Majorana quantum computing](https://www.science.org/content/article/ghostly-quasiparticle-rooted-century-old-mystery-unlock-quantum-computings-potential)** A ghostly quasiparticle rooted in a century-old Italian mystery could unlock quantum computing potential (Science)

1. **[science.abl8371](https://www.science.org/doi/10.1126/science.abl8371)** Time-reversal symmetry breaking superconductivity between twisted cuprate superconductors (Nature)

1. **[s41586-023-06768-0](https://www.nature.com/articles/s41586-023-06768-0)** Exploring large-scale entanglement in quantum simulation (Nature)

1. **[s41586-023-06764-4](https://www.nature.com/articles/s41586-023-06764-4)** Evidence for chiral supercurrent in quantum Hall Josephson junctions (Nature)

1. **[s41586-023-06785-z](https://www.nature.com/articles/s41586-023-06785-z)** Three-dimensional atomic structure and local chemical order of medium- and high-entropy nanoalloys (Nature)



1. **[PhysRevLett.131.256505](https://link.aps.org/doi/10.1103/PhysRevLett.131.256505)** Divergent Nonlinear Response from Quasiparticle Interactions (PRL)





1. **[PhysRevLett.131.258201](https://link.aps.org/doi/10.1103/PhysRevLett.131.258201)** Rationalizing Euclidean Assemblies of Hard Polyhedra from Tessellations in Curved Space (PRL)

1. **[PhysRevLett.131.256001](https://link.aps.org/doi/10.1103/PhysRevLett.131.256001)** Josephson Junction $\\ensuremath{\\pi}\\text{\\ensuremath{-}}0$ Transition Induced by Orbital Hybridization in a Double Quantum Dot (PRL)

1. **[PhysRevLett.131.256504](https://link.aps.org/doi/10.1103/PhysRevLett.131.256504)** Origin of the Magnetic Exciton in the van der Waals Antiferromagnet ${\\mathrm{NiPS}}_{3}$ (PRL)

1. **[PhysRevLett.131.256901](https://link.aps.org/doi/10.1103/PhysRevLett.131.256901)** Berry-Curvature Engineering for Nonreciprocal Directional Dichroism in Two-Dimensional Antiferromagnets (PRL)

1. **[PhysRevLett.131.256503](https://link.aps.org/doi/10.1103/PhysRevLett.131.256503)** Coherent Phonon Assisted Ultrafast Order-Parameter Reversal and Hidden Metallic State in ${\\mathrm{Ta}}_{2}{\\mathrm{NiSe}}_{5}$ (PRL)


1. **[2312.13857](http://arxiv.org/abs/2312.13857)** Superconducting diodes from magnetization gradients (arXiv)

1. **[2312.13367](http://arxiv.org/abs/2312.13367)** Topological Superconductivity in Twisted Flakes of Nodal Superconductors (arXiv)

1. **[2312.13348](http://arxiv.org/abs/2312.13348)** Charge-4$e$ Superconductivity in a Hubbard model (arXiv)

1. **[2312.14002](http://arxiv.org/abs/2312.14002)** Tensor Network Finite-Size Scaling for Two-Dimensional 3-state Clock Model (arXiv)

1. **[2312.13962](http://arxiv.org/abs/2312.13962)** The rich phase diagram of the prototypical iridate Ba$_2$IrO$_4$: Effective low-energy models and metal-insulator transition (arXiv)

1. **[2312.13894](http://arxiv.org/abs/2312.13894)** Direct evidence from high-field magnetotransport for a dramatic change of quasiparticle character in van der Waals ferromagnet Fe$_{3-x}$GeTe$_2$ (arXiv)

1. **[2312.13502](http://arxiv.org/abs/2312.13502)** Energy Relaxation and dynamics in the correlated metal Sr$_2$RuO$_4$ via THz two-dimensional coherent spectroscopy (arXiv)

1. **[2312.13226](http://arxiv.org/abs/2312.13226)** Edge zeros and boundary spinons in topological Mott insulators (**spinon**, arXiv)

1. **[2312.13181](http://arxiv.org/abs/2312.13181)** From Resistance Minimum to Kondo Physics (arXiv)

1. **[2312.12920](http://arxiv.org/abs/2312.12920)** Fermi arcs, Landau levels and magnetic response of the nematic Weyl liquid (**nematic Weyl**, arXiv)

1. **[2312.12889](http://arxiv.org/abs/2312.12889)** Singular Hall response from a correlated ferromagnetic flat nodal-line semimetal (nodal line, arXiv)

1. **[2312.12531](http://arxiv.org/abs/2312.12531)** Topology, magnetism and charge order in twisted MoTe2 at higher integer hole fillings (arXiv)

1. **[2312.13051](http://arxiv.org/abs/2312.13051)** BerryEasy: A GPU enabled python package for diagnosis of $n$-th-order and spin-resolved topology in the presence of fields and effects (arXiv)

1. **[2312.12607](http://arxiv.org/abs/2312.12607)** Graph Theorem for Chiral Exact Flat Bands at Charge Neutrality (arXiv)

1. **[2312.14054](http://arxiv.org/abs/2312.14054)** Theory of interlayer exciton dynamics in 2D TMDCs Heterolayers under the influence of strain reconstruction and disorder (arXiv)

1. **[2312.14034](http://arxiv.org/abs/2312.14034)** Hidden mechanical oscillatory state in a carbon nanotube revealed by noise (arXiv)

1. **[2312.13956](http://arxiv.org/abs/2312.13956)** Quantum Transport and Spectroscopy of Two-dimensional Perovskite/Graphene Interfaces (arXiv)

1. **[2312.13907](http://arxiv.org/abs/2312.13907)** Topological Phase Transitions with Zero Indirect Band Gap (arXiv)
